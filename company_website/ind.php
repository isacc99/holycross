        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="details">
                <h3><a href="PreSchool.html">PreSchool</a></h3>
                <p></p>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="details">
                <h3><a href="SundaySchool.html">Sunday School</a></h3>
                <p></p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="./assets/img/speakers/1 - Copy.jpg" alt="9090" class="img-fluid" width="800" height="600">
              <div class="details">
                <h3><a href="Youth.html">Youth Fellowship</a></h3>
                <p></p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="details">
                <h3><a href="Men.html">Men's Fellowship</a></h3>
                <p></p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="details">
                <h3><a href="Women.html">Women's Fellowship</h3>
                <p></p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="details">
                <h3><a href="Senior.html">Senior Citizen's Fellowship</a></h3>
                <p></p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // Check for DateTime creation errors
        if ($dateTime === false) {
