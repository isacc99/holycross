...
$result = $conn->query("SELECT intro FROM dp WHERE title = 'Sunday School' LIMIT 0, 25;");
$row = $result->fetch_assoc();
$sundayschoolDescription = $row['intro'];
?>
<?php
// Assuming $conn is the database connection variable

// Fetch data from the database
$query = $conn->query("SELECT * FROM sundayschool ORDER BY date_created ASC LIMIT 1");
    ...
    <section id="speakers-details">
        <div class="container">
            <div class="section-header">
                <h2>Sunday School</h2>
                <p><?php echo $sundayschoolDescription; ?></p>
            </div>
...
$query = $conn->query("SELECT * FROM leaders where fellowship = 'sundayschool'");
$rows = $query->fetch_all(MYSQLI_ASSOC);
?>
...
$query_all = $conn->query("SELECT * FROM sundayschool WHERE id <> {$oldest_row['id']}");
