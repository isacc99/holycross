			...
			<form id="about_c">
				<div class="form-group">
					...
					<label for="" class="control-label">About Content</label>
		             <textarea name="content" id="" cols="30" rows="10" class="form-control summernote"><?php echo (is_file(base_app.'about.php')) ? file_get_contents((base_app.'about.html')) : '' ?></textarea>
				</div>
			</form>
		</div>
