...
<?php 
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT * from `senior` where id = '{$_GET['id']}' ");
...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="senior"><?php echo isset($_GET['id']) ? "Update": "Save" ?></button>
...
function displayImg(input,_this) {
	...
	$(document).ready(function(){
		$('.select')
		$('#senior').submit(function(e){
			e.preventDefault();
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Content.php?f=senior",
