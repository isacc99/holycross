            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                  ...
                  <div class="info">
                    <a href="<?php echo base_url ?>admin/?page=user" class="d-block"><?php echo ucwords($_settings->userdata('firstname').' '.$_settings->userdata('lastname')) ?> Profile</a>
                  </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=Churchtime" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=livecreds" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=gallery" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=PastorateCommittee" class="nav-link">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                      Pastorate Committee
                        </p>
