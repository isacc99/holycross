...
$result = $conn->query("SELECT intro FROM dp WHERE title LIKE 'Women%' LIMIT 0, 25;");
$row = $result->fetch_assoc();
$womensDescription = $row['intro'];
?>
<?php
// Assuming $conn is the database connection variable

// Fetch data from the database
$query = $conn->query("SELECT * FROM women ORDER BY date_created ASC LIMIT 1");
    ...
    <section id="speakers-details">
        <div class="container">
            <div class="section-header">
                ...
                <p><?php echo $womensDescription; ?></p>
            </div>
...
$query = $conn->query("SELECT * FROM leaders where fellowship = 'womens'");
$rows = $query->fetch_all(MYSQLI_ASSOC);
?>
...
$query_all = $conn->query("SELECT * FROM women WHERE id <> {$oldest_row['id']}");
